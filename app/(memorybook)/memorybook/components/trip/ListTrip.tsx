        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start my-10 mx-4 px-2">
          {sortedTrips?.map((trip) => {
            return (
              <div
                key={trip.id}
                className="group flex flex-col items-center max-w-[330px] mx-4 mb-6 "
              >
                ...
                <Link href={`/memorybook/${trip.id}/itinerary`}>
                  <div className="flex flex-col w-full min-w-[330px] px-8 py-12 border-2 shadow-xl rounded border-sky-600 bg-white hover:-translate-y-5 transition duration-300">
