  ...
  return (
    <>
      <form action={formAction}>
        ...
        <Form name={"category"} label={"カテゴリ"} defaultValue={post?.category}/>
        <Form name={"slug"} label={"スラッグ"} defaultValue={post?.slug} />
        <Form name={"title"} label={"記事のタイトル"} defaultValue={post?.title}/>
        <TextArea name={"content"} label={"記事の内容"} defaultValue={post?.content}/>
